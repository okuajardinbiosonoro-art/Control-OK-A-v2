...
- ~~Test de campaña OTA end-to-end con hardware real~~ — EJECUTADO en 35.6: EB1 canary COMPLETED, health gate PASSED, reboot confirmado por UDP y serial — ver [`firmware_ota_campaign_hardware_validation.md`](firmware_ota_campaign_hardware_validation.md); deuda CAMP-1 cerrada para la RC
